...
class Equipe(models.Model):
	...
	def __str__(self):
		return self.nome # + ' - ' + self.fk_setor.__str__()
	class Meta:
		verbose_name = "Equipe"
...
class Servidor(models.Model):
	...
	'''
		Mudanças abaixo no campo serv_setor
	'''
	serv_setor = models.ForeignKey(Setor, on_delete = models.RESTRICT)
	fk_equipe = models.ForeignKey(Equipe, on_delete = models.RESTRICT)
	def __str__(self):
		return self.nome
