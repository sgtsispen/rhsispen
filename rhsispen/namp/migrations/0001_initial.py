# Generated by Django 3.1.5 on 2021-05-28 11:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_final', models.DateField(blank=True, null=True)),
                ('fk_funcao', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='namp.funcao', verbose_name='Função')),
                ('fk_servidor', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='namp.servidor', verbose_name='Servidor')),
            ],
            options={
                'verbose_name': 'Cargos e Função',
                'verbose_name_plural': 'Cargo de Funcões',
            },
        ),
        migrations.CreateModel(
