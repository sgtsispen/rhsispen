    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_contato', models.CharField(choices=[('Celular', 'Celular'), ('Telefone Fixo', 'Telefone Fixo')], max_length=50, verbose_name='Tipo: ')),
                ('contato', models.CharField(blank=True, max_length=50, null=True, verbose_name='Número para contato: ')),
